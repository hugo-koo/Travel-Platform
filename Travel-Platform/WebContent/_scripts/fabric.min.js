...
/**
 * Office UI Fabric JS 1.2.0 The JavaScript front-end framework for building
 * experiences for Office 365.
 */
var fabric;
!function (e) {
    var t = 33
        , i = function () {
            ...
            return e.transition = function (t, i) {
                ...
                e._animationObjects.push(n),
                    e._parseProperties(n),
                    e._createTransition(n),
                    setTimeout(e._setProperties, 0, n),
                    e._setCallback(n)
            }
                ,
                e.animation = function (t, i, n) {
                    ...
                    e._animationObjects.push(s),
                        e._parseProperties(s),
                        e._createAnimation(s),
                        e._setCallback(s)
                }
                ,
                e.scrollTo = function (t, i) {
                    ...
                    e._setScrollProperties(n),
                        n.props.delay ? setTimeout(e._animationObjects, 1e3 * n.props.delay, n) : e._animateScroll(n),
                        e._animationObjects.push(n)
                }
                ,
                ...
                e._animateScroll = function (i) {
                    ...
                    i.element.scrollTop = s,
                        i.step >= n ? (i.element.scrollTop = i.props.top,
                            e._executeCallback(i.props),
                            e._removeAnimationObject(i)) : setTimeout(function () {
                ...
                e._createTransition = function (t) {
                    ...
                    t.element.style.transitionProperty = e._getTransitionProperties(t.tweenObj),
                        t.element.style.transitionDuration = i.toString() + "s",
                        t.element.style.transitionTimingFunction = t.ease || "linear",
                        t.element.style.transitionDelay = n.toString() + "s"
                }
                ,
                e._createAnimation = function (e) {
                    ...
                    e.element.style.animationName = e.keyframes,
                        ...
                        e.element.style.animationDelay = i.toString() + "s",
                ...
                e._getTransitionProperties = function (t) {
                    ...
                    return i && s.push("transform"),
                        n && (s.push("-webkit-filter"),
                            s.push("filter")),
                        s.join(", ")
                }
                ,
                ...
                e._setRegularValues = function (e, t) {
                    var i = e.tweenObj[t];
                    i.toString().indexOf("%") === -1 && (i += "opacity" !== t && "backgroundColor" !== t && "boxShadow" !== t ? "px" : ""),
                        e.element.style[t] = i
                }
                ,
                e._setFilterValues = function (t, i) {
                    var n = t.tweenObj[i];
                    n = "hueRotate" === i ? "(" + n + "deg)" : "blur" === i ? "(" + n + "px)" : "(" + n + "%)",
                        i = e._camelCaseToDash(i),
                        t.element.style.webkitFilter = i + n,
                        t.element.style.filter = i + n
                }
                ,
                ...
                e._setTransformations = function (e) {
                    var t = ""
                        ...
                        , s = ""
                        , o = e.transformations;
                    s += void 0 !== o.x && o.x ? "translateX(" + o.x + "px) " : "",
                        s += void 0 !== o.y && o.y ? "translateY(" + o.y + "px) " : "",
                        s += void 0 !== o.z && o.z ? "translateZ(" + o.z + "px) " : "",
                        ...
                        i += void 0 !== o.scaleX && o.scaleX ? "scaleX(" + o.scaleX + ") " : "",
                        i += void 0 !== o.scaleY && o.scaleY ? "scaleY(" + o.scaleY + ") " : "",
                        i += void 0 !== o.scaleZ && o.scaleZ ? "scaleZ(" + o.scaleZ + ") " : "",
                        n += void 0 !== o.skewX && o.skewX ? "skewX(" + o.skewX + "deg) " : "",
                        n += void 0 !== o.skewY && o.skewY ? "skewY(" + o.skewY + "deg) " : "",
                        e.element.style.transform = s + t + i + n
                }
                ,
                ...
                e._complete = function (t) {
                    ...
                    e._executeCallback(i),
                        e._removeAnimationObject(i)
                }
                ,
                e._getAnimationObjByElement = function (t) {
                    for (var i = e._animationObjects.length; i--;)
                        if (e._animationObjects[i].element === t)
                            return e._animationObjects[i];
                    return null
                }
                ,
                ...
                ,
                e._transformProps = ["x", "y", "z", "scaleX", "scaleY", "scaleZ", "rotate", "rotateX", "rotateY", "rotateZ", "skewX", "skewY"],
...
!function (e) {
    var t = function () {
        function e() { }
        return e.QUAD_EASE_IN = e.CB + "(0.550, 0.085, 0.680, 0.530)",
...
!function (e) {
    ...
    var t = function () {
        ...
        return e.prototype.removeOutlinesOnClick = function () {
            ...
            ,
            e.prototype.addItem = function (e, t, i) {
            ...
            e.prototype.removeItemByPosition = function (e) {
                this._itemCollection.splice(e, 1),
                    this._updateBreadcrumbs()
            }
            ,
            ...
            e.prototype._createItemCollection = function () {
                var e, t, i, n, s = this._listItems.length, o = 0;
                for (o; o < s; o++)
                    e = this._listItems[o].querySelector(".ms-Breadcrumb-itemLink"),
                        t = e.textContent,
            ...
            e.prototype._updateBreadcrumbs = function () {
                var t = window.innerWidth > e.MEDIUM ? 4 : 2;
                this._itemCollection.length > t ? this._breadcrumb.classList.add("is-overflow") : this._breadcrumb.classList.remove("is-overflow"),
            ...
            e.prototype._addItemsToOverflow = function (e) {
                ...
                n.forEach(function (e) {
                    ...
                    i.className = "ms-ContextualMenu-item",
                        isNaN(e.tabIndex) || i.setAttribute("tabindex", e.tabIndex);
                    var n = document.createElement("a");
                    n.className = "ms-ContextualMenu-link",
                        null !== e.link && n.setAttribute("href", e.link),
                        n.textContent = e.text,
                        i.appendChild(n),
                        t._contextMenu.appendChild(i)
                })
            }
            ,
                ...
                if (t = t < 0 ? 0 : t,
                    ...
                    for (t; t < this._itemCollection.length; t++) {
                        ...
                        i.className = "ms-Breadcrumb-listItem",
                            ...
                            null !== n.link && s.setAttribute("href", n.link),
                            isNaN(n.tabIndex) || s.setAttribute("tabindex", n.tabIndex),
                            s.textContent = n.text,
                            o.className = "ms-Breadcrumb-chevron ms-Icon ms-Icon--ChevronRight",
                            i.appendChild(s),
                            i.appendChild(o),
                            this._breadcrumbList.appendChild(i)
                    }
            }
            ,
            ...
            e.prototype._openOverflow = function (e) {
                this._overflowMenu.className.indexOf(" is-open") === -1 && (this._overflowMenu.classList.add("is-open"),
            ...
            e.prototype._setListeners = function () {
                window.addEventListener("resize", this._onResize.bind(this)),
                    this._overflowButton.addEventListener("click", this._openOverflow.bind(this), !1),
                    this._overflowButton.addEventListener("keypress", this._overflowKeyPress.bind(this), !1),
                    document.addEventListener("click", this._closeOverflow.bind(this), !1),
        ...
        , u = function () {
            function e(t, i, o, r, a, c, h) {
                if (void 0 === r && (r = !0),
                    ...
                    this._contextualHostMain = this._contextualHost.getElementsByClassName(n)[0],
                    this._contextualHostMain.appendChild(t),
                    this._hasArrow = r,
                    this._arrow = this._container.getElementsByClassName(s)[0],
                    this._targetElement = o,
                    this._openModal(),
                    this._setResizeDisposal(),
                    h && (this._disposalCallback = h),
                    a)
            ...
            return e.prototype.disposeModal = function () {
                if (e.hosts.length > 0) {
                    ...
                    e.hosts.splice(t, 1);
                    for (var i = e.hosts.length; i--;)
                        e.hosts[i].disposeModal(),
                            e.hosts.splice(i, 1)
                }
            }
                ,
                ...
                e.prototype._findAvailablePosition = function () {
                    ...
                    switch (this._direction) {
                        case "left":
                            e = this._positionOk(this._tryPosModalLeft.bind(this), this._tryPosModalRight.bind(this), this._tryPosModalBottom.bind(this), this._tryPosModalTop.bind(this)),
                                this._setPosition(e);
                            break;
                        case "right":
                            e = this._positionOk(this._tryPosModalRight.bind(this), this._tryPosModalLeft.bind(this), this._tryPosModalBottom.bind(this), this._tryPosModalTop.bind(this)),
                                this._setPosition(e);
                            break;
                        case "top":
                            e = this._positionOk(this._tryPosModalTop.bind(this), this._tryPosModalBottom.bind(this)),
                                this._setPosition(e);
                            break;
                        case "bottom":
                            e = this._positionOk(this._tryPosModalBottom.bind(this), this._tryPosModalTop.bind(this)),
                                this._setPosition(e);
                            break;
                        default:
                            this._setPosition()
                ...
                e.prototype._setPosition = function (e) {
                    var t, n, s, l = this._targetElement.getBoundingClientRect(), u = l.left, _ = l.right, p = l.top, m = l.height, f = "", v = window.scrollY ? window.scrollY : 0, y = this._hasArrow ? h : 0;
                    switch (this._matchTargetWidth && (f = "width: " + this._modalWidth + "px;"),
                    e) {
                        case "left":
                            t = u - this._modalWidth + y,
                                n = this._calcTop(this._modalHeight, m, p),
                                n += window.scrollY ? window.scrollY : 0,
                                this._container.setAttribute("style", "top: " + n + "px; left: " + t + "px;" + f),
                                this._container.classList.add(i),
                                this._hasArrow && (this._container.classList.add(c),
                                    s = p + v - n + d,
                                    this._arrow.setAttribute("style", "top: " + s + "px;"));
                            break;
                        case "right":
                            n = this._calcTop(this._modalHeight, m, p),
                                n += v,
                                ...
                                this._container.setAttribute("style", "top: " + n + "px; left: " + t + "px;" + f),
                                this._container.classList.add(i),
                                this._hasArrow && (s = v + p - n + d,
                                    this._arrow.setAttribute("style", "top: " + s + "px;"),
                                    this._container.classList.add(o));
                            break;
                        case "top":
                            t = this._calcLeft(this._modalWidth, this._teWidth, u),
                                n = p - this._modalHeight + y,
                                n += v,
                                this._container.setAttribute("style", "top: " + n + "px; left: " + t + "px;" + f),
                                this._container.classList.add(i),
                                this._hasArrow && this._container.classList.add(a);
                            break;
                        case "bottom":
                            t = t = this._calcLeft(this._modalWidth, this._teWidth, u),
                                n = p + m + y,
                                n += window.scrollY ? window.scrollY : 0,
                                this._container.setAttribute("style", "top: " + n + "px; left: " + t + "px;" + f),
                                this._container.classList.add(i),
                                this._hasArrow && this._container.classList.add(r);
                            break;
                        default:
                ...
                e.prototype._saveModalSize = function () {
                    ...
                    if (this._container.setAttribute("style", "opacity: 0; z-index: -1"),
                        this._container.classList.add(i),
                        this._container.classList.add(t),
                        ...
                        this._modalWidth = this._container.getBoundingClientRect().width + (parseInt(e.marginLeft, 10) + parseInt(e.marginRight, 10)),
                            this._container.setAttribute("style", "");
                    this._modalHeight = this._container.getBoundingClientRect().height + (parseInt(e.marginTop, 10) + parseInt(e.marginBottom, 10)),
                        this._container.classList.remove(i),
...
var STATE_HIDDEN = "is-hidden", CLOSE_BUTTON_CLASS = ".ms-Callout-close", MODIFIER_OOBE_CLASS = "ms-Callout--OOBE", fabric;
!function (e) {
    "use strict";
    var t = function () {
        function t(e, t, i) {
        ...
        return t.prototype._setOpener = function () {
            ...
            t.prototype._openContextMenu = function () {
                var t = [];
                this._hasModifier(MODIFIER_OOBE_CLASS) && t.push("primaryArrow"),
    ...
    var t = function () {
        ...
        return e.prototype.getValue = function () {
            ...
            e.prototype._ClickHandler = function (e) {
                e.stopPropagation(),
                    e.preventDefault(),
                    this._choiceField.classList.contains("is-disabled") || this.toggle()
            }
            ,
        ...
        , a = function () {
            ...
            return e.prototype.setCollapsedListeners = function () {
                ...
                e.prototype._saveDOMRefs = function (e) {
                    this._searchBox = e,
                        this._searchBoxField = this._searchBox.querySelector(t),
                        this._searchBoxClearButton = this._searchBox.querySelector(i),
                        this._searchBoxExitButton = this._searchBox.querySelector(n)
                }
                ,
                ...
                e.prototype._setClearButtonAction = function () {
                    ...
                    this._searchBoxExitButton && this._searchBoxExitButton.addEventListener("click", this._boundExitSearchBox, !1),
                        ...
                        this._searchBoxClearButton.addEventListener("keydown", function (t) {
                            var i = t.keyCode;
                ...
                e.prototype._handleBlur = function (e) {
                    var t = this;
                    this._clearOnly ? this._searchBoxField.focus() : (this._searchBox.removeEventListener("keyup", this._boundEnableClose),
                        setTimeout(function () {
                            t._searchBox.contains(document.activeElement) || (t._clearSearchBox(),
        ...
        , o = function () {
            function o(e, s) {
                this._container = e,
                    ...
                    this._commandButton = this._command.querySelector(n),
                    this._splitButton = this._command.querySelector(i),
                    s ? this._contextualMenu = s : this._contextualMenu = this._container.querySelector(t),
                    this._checkForMenu()
            }
        ...
        , m = function () {
            ...
            return m.prototype._runsSearchBox = function (e) {
                ...
                m.prototype._runOverflow = function () {
                    this._elements.overflowCommand && (this._saveCommandWidths(),
                        this._redrawMenu(),
                ...
                m.prototype._initOverflow = function () {
                    this._createContextualRef(),
                        ...
                        this._createItemCollection(this._sideAreaCollection, r),
                ...
                m.prototype._onSearchExpand = function () {
                    "lg" === this.breakpoint && (this._container.classList.add("search-expanded"),
                        this._doResize())
                }
                ,
                m.prototype._onSearchCollapse = function () {
                    "lg" === this.breakpoint && (this._container.classList.remove("search-expanded"),
                        this._doResize())
                }
                ,
                m.prototype._getScreenSize = function () {
                    ...
                    return t.x = e.innerWidth || n.clientWidth || s.clientWidth,
                        t.y = e.innerHeight || n.clientHeight || s.clientHeight,
                        t
                }
                ,
                ...
                m.prototype._setElements = function () {
                    ...
                    this._elements = {
                        ...
                        this._container.querySelector(r) && (this._elements.sideCommandArea = this._container.querySelector(r)),
                        this._container.querySelector(a) && (this._elements.overflowCommand = this._container.querySelector(a),
                            this._elements.contextMenu = this._container.querySelector(a).querySelector(t)),
                        this._container.querySelector(o + " " + s) && (this._elements.searchBox = this._container.querySelector(o + " " + s),
                            this._elements.searchBoxClose = this._container.querySelector(l),
                ...
                m.prototype._createItemCollection = function (t, i) {
                    ...
                    for (var _ = 0; _ < l.length; _++) {
                        n = l[_],
                            s = n.querySelector(d).textContent;
                        var p = n.querySelector(u);
                        if (p) {
                            o = p.className,
                                r = o.split(" ");
                            for (var m = 0; m < r.length; m++)
                                if (r[m].indexOf(u.replace(".", "") + "--") > -1) {
                                    p = r[m];
                                    break
                                }
                        }
                ...
                m.prototype._createContextualRef = function () {
                    this.contextualItemContainerRef = this._elements.contextMenu.querySelector(i).cloneNode(!0),
                        this.contextualItemLink = this._elements.contextMenu.querySelector(n).cloneNode(!1),
                ...
                m.prototype._getElementWidth = function (e) {
                    var t, i;
                    return null === e.offsetParent && e.setAttribute("style", "position: absolute; opacity: 0; display: block;"),
                        t = e.getBoundingClientRect().width,
                        i = window.getComputedStyle(e),
                        t += parseInt(i.marginLeft, 10) + parseInt(i.marginRight, 10),
                ...
                m.prototype._updateCommands = function () {
                    ...
                    this.visibleCommands = [],
                        this.overflowCommands = [];
                    for (var s = 0, o = 0; o < this.itemCollection.length; o++)
                        s += this.commandWidths[o],
                            s < n ? this.visibleCommands.push(this.itemCollection[o]) : this.overflowCommands.push(this.itemCollection[o])
                }
                ,
                m.prototype._drawCommands = function () {
                    ...
                    for (var e = 0; e < this.overflowCommands.length; e++) {
                        ...
                        if (i.innerText = this.overflowCommands[e].label,
                            t.appendChild(i),
                            n) {
                            var s = this.contextualItemIcon.cloneNode(!1);
                            s.className = u.replace(".", "") + " " + n,
                                t.appendChild(s)
                        }
                ...
                m.prototype._checkOverflow = function () {
                    this.overflowCommands.length > 0 ? this._elements.overflowCommand.classList.remove("is-hidden") : (this._elements.overflowCommand.classList.add("is-hidden"),
                ...
                m.prototype._redrawMenu = function () {
                    var e;
                    this._hasClass(this._elements.contextMenu, "is-open") && (e = this.activeCommand.getBoundingClientRect().left,
        ...
        , n = function () {
            ...
            return n.prototype.getHost = function () {
                ...
                n.prototype._onContextualMenuClick = function (e) {
                    var t = e.target
                        , i = t.classList;
                    i.contains("ms-ContextualMenu-link") && !i.contains("is-disabled") && (this._container.classList.contains("ms-ContextualMenu--multiselect") ? this._multiSelect(t) : (this._singleSelect(t),
                        t.parentElement.classList.contains("ms-ContextualMenu-item--hasMenu") || this._host.disposeModal()))
                }
                ,
                ...
                n.prototype._createModalHostView = function (t, i, n) {
                    t.classList.remove("is-hidden"),
                        this._host = new e.ContextualHost(t, i, n, (!1));
                    var s = document.createEvent("Event");
                    s.initEvent("hostAdded", !0, !0),
                        t.dispatchEvent(s)
                }
                ,
                n
        ...
        return e.prototype.initCustomView = function (e) {
            ...
            i.appendTo(r),
                ...
                i.on("click", ".js-prevMonth", function (e) {
                    ...
                    t.changeHighlightedDate(a, null, i, null)
                }),
                ...
                s.on("click", ".js-prevYear", function (e) {
                    ...
                    t.changeHighlightedDate(a, i, null, null)
                }),
                ...
                n.click(function (t) {
                    t.preventDefault();
                    var i = new Date;
                    a.set("select", [i.getFullYear(), i.getMonth(), i.getDate()]),
                ...
                s.on("click", ".js-changeDate", function (i) {
                    ...
                    var n = $(i.target)
                        ...
                        , o = n.attr("data-month")
                        , r = n.attr("data-day");
                    t.changeHighlightedDate(a, s, o, r),
                        e.hasClass("is-pickingMonths") && e.removeClass("is-pickingMonths")
                }),
                o.on("click", ".js-changeDate", function (i) {
                    ...
                    var n = $(i.target)
                        ...
                        , r = n.attr("data-day");
                    t.changeHighlightedDate(a, s, o, r),
                        e.hasClass("is-pickingYears") && e.removeClass("is-pickingYears")
                }),
            ...
            ,
            e.prototype.changeHighlightedDate = function (e, t, i, n) {
                "undefined" != typeof t && null !== t || (t = e.get("highlight").year),
                    "undefined" != typeof i && null !== i || (i = e.get("highlight").month),
                    "undefined" != typeof n && null !== n || (n = e.get("highlight").date),
                    e.set("highlight", [t, i, n])
            }
            ,
            e.prototype.updateCustomView = function (e) {
                ...
                t.find(".ms-DatePicker-currentYear").text(n.get("view").year),
                    t.find(".ms-DatePicker-monthOption").removeClass("is-highlighted"),
                    t.find(".ms-DatePicker-monthOption[data-month='" + n.get("highlight").month + "']").addClass("is-highlighted"),
                    i.find(".ms-DatePicker-currentDecade").remove(),
                    i.find(".ms-DatePicker-optionGrid").remove();
                var s = n.get("highlight").year - 11
                    , o = s + " - " + (s + 11)
                    , r = "<div class='ms-DatePicker-currentDecade'>" + o + "</div>";
                r += "<div class='ms-DatePicker-optionGrid'>";
                for (var a = s; a < s + 12; a++)
                    r += "<span class='ms-DatePicker-yearOption js-changeDate' data-year='" + a + "'>" + a + "</span>";
                r += "</div>",
                    i.append(r),
                    i.find(".ms-DatePicker-yearOption").removeClass("is-highlighted"),
                    i.find(".ms-DatePicker-yearOption[data-year='" + n.get("highlight").year + "']").addClass("is-highlighted")
            }
            ,
        ...
        return t.prototype.close = function () {
            ...
            t.prototype.open = function () {
                this._dialog.classList.add("is-open"),
                    ...
                    this._dialog.classList.contains("ms-Dialog--blocking") || (this._overlay.overlayElement.addEventListener("click", this.close.bind(this), !1),
                        this._overlay.show(),
                        document.body.classList.add("ms-u-overflowHidden")),
        ...
        , i = function () {
            ...
            return i.prototype.dismiss = function () {
                ...
                i.prototype.update = function (e, t) {
                    this.panelHost.replaceChild(e, this._layer),
                        t && t()
                }
                ,
                ...
                i.prototype._createElements = function () {
                    this.panelHost = document.createElement("div"),
                        this.panelHost.classList.add(t),
                        this.panelHost.appendChild(this._layer),
                        this._overlay = new e.Overlay(this._overlayContainer),
                        this._overlay.show(),
...
!function (e) {
    var t = "animate-in"
        ...
        , s = function () {
            function s(t, i, n) {
                this._panel = t,
                    this._direction = i || "right",
                    this._animateOverlay = n || !0,
                    this._panelHost = new e.PanelHost(this._panel, this._animateInPanel),
            ...
            return s.prototype.dismiss = function (e) {
                var t = this;
                this._panel.classList.add(i),
                    setTimeout(function () {
                        t._panel.classList.remove(i),
                            t._panel.classList.remove("is-open"),
                            t._panelHost.dismiss(),
                            e && e(),
        ...
        , u = function () {
            function u(e) {
                this._container = e,
                    ...
                    this._newDropdownLabel.classList.add(i),
                    this._newDropdown = document.createElement("ul"),
                    this._newDropdown.classList.add(n),
                    this._dropdownItems = [],
                    this._originalDropdown = e.querySelector(o);
                ...
                for (var r = 0; r < t.length; ++r) {
                    ...
                    l.classList.add(s),
                        a.disabled && l.classList.add(c),
                        l.innerHTML = a.text,
                        l.addEventListener("click", this._onItemSelection),
                        this._newDropdown.appendChild(l),
            ...
            return u.prototype._setWindowEvent = function () {
                ...
                u.prototype._doResize = function () {
                    var e = this._container.classList.contains(a);
                    if (e) {
                        var t = this._getScreenSize().x;
                        t <= d ? this._openDropdownAsPanel() : this._removeDropdownAsPanel()
                    }
                }
                ,
                u.prototype._openDropdownAsPanel = function () {
                    void 0 === this._panel && (this._panelContainer = document.createElement("div"),
                        this._panelContainer.classList.add(r),
                        this._panelContainer.classList.add(t),
                        this._panelContainer.classList.add(a),
                        this._panelContainer.classList.add(h),
                        this._panelContainer.appendChild(this._newDropdown),
                        this._panel = new e.Panel(this._panelContainer))
                }
                ,
                u.prototype._removeDropdownAsPanel = function () {
                    var e = this;
                    void 0 !== this._panel && (this._panel.dismiss(function () {
                        e._container.appendChild(e._newDropdown)
                    }),
                        this._panel = void 0)
                }
                ,
                u.prototype._onOpenDropdown = function (e) {
                    var t = this._container.classList.contains(c)
                        , i = this._container.classList.contains(a);
                    if (!t && !i) {
                        e.stopPropagation(),
                            this._container.classList.add(a),
                            document.addEventListener("click", this._onCloseDropdown);
                        var n = this._getScreenSize().x;
                        n <= d && this._openDropdownAsPanel()
                    }
                }
                ,
                u.prototype._onCloseDropdown = function () {
                    this._removeDropdownAsPanel(),
                        this._container.classList.remove(a),
                ...
                u.prototype._onItemSelection = function (e) {
                    var t = e.target
                        ...
                        , n = t.classList.contains(c);
                    if (!i && !n) {
                        for (var s = 0; s < this._dropdownItems.length; ++s)
                            this._dropdownItems[s].newItem === t ? (this._dropdownItems[s].newItem.classList.add(l),
                                this._dropdownItems[s].oldOption.selected = !0) : (this._dropdownItems[s].newItem.classList.remove(l),
                                    this._dropdownItems[s].oldOption.selected = !1);
                        this._newDropdownLabel.innerHTML = t.textContent;
                        var o = document.createEvent("HTMLEvents");
                        o.initEvent("change", !1, !0),
                            this._originalDropdown.dispatchEvent(o)
                    }
                }
                ,
                u
    ...
    var t = function () {
        ...
        return t.prototype.removeListeners = function () {
            ...
            t.prototype._onActionClick = function (e) {
                var t = e.target
                    , i = t.getAttribute("data-action-id");
                i && t.className.indexOf("is-active") === -1 && (this._setAction(t),
                    this._setDetail(i))
            }
            ,
        ...
        , i = function () {
            function i(e) {
                this._persona = e,
                    ...
                    this._personaCard && (this._assignEvents(),
            ...
            return i.prototype._createPersonaCard = function () {
                ...
                i.prototype._createContextualHostInstance = function () {
                    this._personaCard.setAttribute("style", "display: block;"),
                        this._contextualHostInstance = new e.ContextualHost(this._personaCard, t, this._persona)
                }
                ,
                ...
                i.prototype._assignEvents = function () {
                    ...
                    this._persona.addEventListener("click", this._personaEventHandler.bind(this), !1),
                        this._persona.addEventListener("keyup", function (t) {
...
!function (e) {
    var t = function () {
        function t(t) {
            ...
            for (var i = this._container.querySelectorAll(".ms-ListItem"), n = 0; n < i.length; n++)
    ...
    var t = function () {
        ...
        return e.prototype.init = function () {
            ...
            e.prototype._resizeRegular = function () {
                this._clientWidth - this._bufferSize > this._initTextWidth && this._initTextWidth < this._textContainerMaxWidth ? (this._textWidth = "auto",
                    this._chevronButton.className = "ms-MessageBanner-expand",
                    this._collapse()) : (this._textWidth = Math.min(this._clientWidth - this._bufferSize, this._textContainerMaxWidth) + "px",
                        this._chevronButton.className.indexOf("is-visible") === -1 && (this._chevronButton.className += " is-visible")),
                    this._clipper.style.width = this._textWidth
            }
            ,
            e.prototype._resizeSmall = function () {
                this._clientWidth - (this._bufferElementsWidthSmall + this._closeButton.offsetWidth) > this._initTextWidth ? (this._textWidth = "auto",
                    this._collapse()) : this._textWidth = this._clientWidth - (this._bufferElementsWidthSmall + this._closeButton.offsetWidth) + "px",
                    this._clipper.style.width = this._textWidth
            }
            ,
            e.prototype._cacheDOM = function () {
            ...
            e.prototype._expand = function () {
                ...
                this._errorBanner.className += " is-expanded",
                    e.className = "ms-Icon ms-Icon--chevronsUp"
            }
            ,
            e.prototype._collapse = function () {
                var e = this._chevronButton.querySelector(".ms-Icon");
                this._errorBanner.className = "ms-MessageBanner",
                    e.className = "ms-Icon ms-Icon--chevronsDown"
            }
            ,
            ...
            e.prototype._hideBanner = function () {
                this._errorBanner.className.indexOf("hide") === -1 && (this._errorBanner.className += " hide",
            ...
            e.prototype._setListeners = function () {
                window.addEventListener("resize", this._onResize.bind(this), !1),
                    ...
                    this._closeButton.addEventListener("click", this._hideBanner.bind(this), !1)
            }
            ,
            e
    }();
        ...
        , n = function () {
            function n(e) {
                this._container = e,
                    ...
                    this._assignClicks(),
                    this._selectedPeople && (this._assignRemoveHandler(),
            ...
            return n.prototype._createModalHost = function (i) {
                i.stopPropagation(),
                    ...
                    this._contextualHostView = new e.ContextualHost(this._peoplePickerMenu, t, this._peoplePickerSearchBox, (!1), [""], (!0), this._contextHostCallBack.bind(this)),
                ...
                n.prototype._clickHandler = function (e) {
                    ...
                    for (var s = 0; s < this._peoplePickerResults.length; s++) {
                        ...
                        o.addEventListener("click", this._selectResult.bind(this), !0),
                            r.addEventListener("click", this._removeItem.bind(this), !0)
                    }
                }
                ,
                n.prototype._selectResult = function (e) {
                    ...
                    var t = this._findElement(e.target, "ms-Persona")
                        , i = t.cloneNode(!0);
                    this._container.classList.contains("ms-PeoplePicker--facePile") ? this._addResultToMembers(i) : this._tokenizeResult(i),
                        this._updateCount(),
                ...
                n.prototype._addRemoveBtn = function (e, t) {
                    ...
                    t ? (i = document.createElement("div"),
                        i.classList.add("ms-Persona-actionIcon"),
                        i.addEventListener("click", this._removeToken.bind(this), !0)) : (i = document.createElement("button"),
                            i.classList.add("ms-PeoplePicker-resultAction"),
                            i.addEventListener("click", this._removeResult.bind(this), !0)),
                        n.classList.add("ms-Icon", "ms-Icon--Cancel"),
                        i.appendChild(n),
                        e.appendChild(i)
                }
                ,
                ...
                n.prototype._updateCount = function () {
                    if (this._selectedPeople) {
                        ...
                        this._selectedCount.textContent = e.toString(),
                            this._selectedPlural.style.display = 1 === e ? "none" : "inline"
                    }
                }
                ,
                n.prototype._tokenizeResult = function (e) {
                    ...
                    e.classList.add(i, "ms-PeoplePicker-persona"),
                        this._addRemoveBtn(e, !0),
                        e.classList.contains("ms-Persona--sm") && (e.classList.remove("ms-Persona--sm"),
                ...
                n.prototype._addResultToMembers = function (e) {
                    ...
                    n.classList.add("ms-PeoplePicker-selectedPerson"),
                        n.tabIndex = 1,
                        n.appendChild(e),
                        this._addRemoveBtn(n, !1),
                        n.querySelector(".ms-PeoplePicker-resultAction").addEventListener("click", this._removeResult.bind(this), !0),
                        t.insertBefore(n, i)
                }
                ,
                n.prototype._assignClicks = function () {
                    ...
                    this._peoplePickerSearch.addEventListener("click", this._clickHandler.bind(this), !0),
                        this._peoplePickerSearch.addEventListener("keyup", function (t) {
        ...
        return e.prototype.removeListeners = function () {
            ...
            e.prototype._addListeners = function () {
                ...
                this._container.querySelector(".ms-Pivot-links").addEventListener("click", this._selectTabMouse.bind(this), !1),
                    this._container.addEventListener("keyup", function (t) {
        ...
        , i = function () {
            ...
            return e.prototype.start = function () {
                ...
                e.prototype._setPropertiesForSize = function () {
                    this.spinner.className.indexOf("large") > -1 && (this.parentSize = 28,
                        this.eightSize = .179),
                ...
                e.prototype._setTargetElement = function () {
                    this._target.className.indexOf("ms-Spinner") === -1 ? (this.spinner = document.createElement("div"),
                        this.spinner.className = "ms-Spinner",
                        this._target.appendChild(this.spinner)) : this.spinner = this._target
                }
                ,
                e.prototype._initializeOpacities = function () {
                    var e, t = 0, i = 1;
                    for (this.fadeIncrement = 1 / this.numCircles,
                        t; t < this.numCircles; t++) {
                        var n = this.circleObjects[t];
                        e = this.fadeIncrement * i++,
                            this._setOpacity(n.element, e)
                    }
                }
                ,
                ...
                e.prototype._createCircle = function () {
                    var e = document.createElement("div");
                    return e.className = "ms-Spinner-circle",
                        e.style.width = e.style.height = this.parentSize * this.offsetSize + "px",
                        e
                }
                ,
...
!function (e) {
    ...
    var t = function () {
        function e(e) {
            this.container = e,
                this.container.className.indexOf("ms-Table--selectable") !== -1 && this._addListeners()
        }
        ...
        return e.prototype.removeListeners = function () {
            ...
            e.prototype._addListeners = function () {
                ...
                this._toggleField.addEventListener("click", this._toggleHandler.bind(this), !1),
                    this._toggleField.addEventListener("keyup", function (t) {
